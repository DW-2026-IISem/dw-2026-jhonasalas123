...
#### 10. DTO de actualización para CitaServicio

![](images/clipboard-247565089.png)

#### 11. Mapper de CitaServicio

![](images/clipboard-319875247.png)

#### 12. Caso de uso para eliminar CitaServicio ![](images/clipboard-760787222.png)

#### 13. Caso de uso para obtener CitaServicio

![](images/clipboard-2268908234.png)

#### 14. Caso de uso para listar CitaServicio

![](images/clipboard-1006618840.png)

#### 15. Caso de uso para actualizar CitaServicio

![](images/clipboard-3968423362.png)

#### 16. Serializer de CitaServicio

![](images/clipboard-3145991341.png)

#### 17. Controlador HTTP de CitaServicio

![](images/clipboard-2956559667.png)

#### 18. Archivo de exportación del módulo CitaServicio

![](images/clipboard-3999928415.png)

#### 19. Módulo de CitaServicio

![](images/clipboard-496581828.png)

#### 20. Registro del modelo CitaServicio en Sequelize

![](images/clipboard-440014036.png)

#### 21. Integración de CitaServicio en BusinessModule

![](images/clipboard-407559367.png)

#### 22. Integración del seeder de CitaServicio

![](images/clipboard-1555350959.png)

#### 23. Integración de BusinessModule en AppModule

![](images/clipboard-3502097002.png)

#### **24.Verificar tabla física `CitaServicio`y API**

![](images/clipboard-1850639477.png)

### Entidad Producto — HuellaMarket

#### 1. Interfaz del repositorio de Producto

![](images/clipboard-795332308.png)

#### 2. Modelo Sequelize de Producto

![](images/clipboard-2070336004.png)

#### 3. Repositorio de Producto

![](images/clipboard-291307741.png)

#### 4. Migración de la tabla Producto

![](images/clipboard-945887627.png)

#### 5. Seeder de Producto

![](images/clipboard-2186421990.png)

#### 6. DTO de filtro para Producto

![](images/clipboard-445999794.png)

#### 7. DTO de respuesta para Producto

![](images/clipboard-3102737412.png)

#### 8. DTO de creación de Producto

![](images/clipboard-804682285.png)

#### 9. DTO de actualización de Producto

![](images/clipboard-211326336.png)

#### 10. Mapper de Producto

![](images/clipboard-3829346264.png)

#### 11. Caso de uso para crear Producto

![](images/clipboard-4267662213.png)

#### 12. Caso de uso para eliminar Producto

![](images/clipboard-3523450330.png)

#### 13. Caso de uso para obtener Producto

![](images/clipboard-3528738290.png)

#### 14. Caso de uso para listar Productos

![](images/clipboard-444515786.png)

#### 15. Caso de uso para actualizar Producto

![](images/clipboard-202836429.png)

#### 16. Serializer de Producto

![](images/clipboard-929207879.png)

#### 17. Controlador HTTP de Producto

![](images/clipboard-1596191477.png)

#### 18. Archivo de exportación del módulo Producto

![](images/clipboard-600010377.png)

#### 19. Módulo de Producto

![](images/clipboard-296005268.png)

#### 20. Registro del modelo Producto en Sequelize

![](images/clipboard-1057060132.png)

#### 21. Integración de Producto en BusinessModule

![](images/clipboard-2881577745.png)

####  22.Integración del Seeder de Productos

![](images/clipboard-2722467432.png)

#### **23.Verificar tabla física Productos y API**

![](images/clipboard-2995499683.png)

### Entidad Proveedor — HuellaMarket

![](images/clipboard-1202148850.png)

#### 1.Excepción de email duplicado

![](images/clipboard-3956722776.png)

#### 2.Excepción de proveedor no encontrado

![](images/clipboard-119373474.png)

#### 3.Validador de email

![](images/clipboard-3400110059.png)

#### 5. Validador de teléfono de Proveedor

![](images/clipboard-1958484202.png)

#### 6. Interfaz del repositorio de Proveedor

![](images/clipboard-565353188.png)

#### 7.Modelo Sequelize

![](images/clipboard-982510250.png)

#### 8.Repositorio

![](images/clipboard-3754241421.png)

#### 9.Migracion

![](images/clipboard-1002063573.png)

####  10.Seeder

![](images/clipboard-1177756080.png)

#### 11. DTO de filtros de Proveedor

![](images/clipboard-963997999.png)

#### 12. DTO de respuesta de Proveedor

![](images/clipboard-4252323566.png)

#### 13. DTO para crear Proveedor

![](images/clipboard-2165761704.png)

#### 14.DTO de actualización de Proveedor

![](images/clipboard-1785310048.png)

#### 15. Mapper de Proveedor

![](images/clipboard-42408239.png)

#### 16. Caso de uso para crear Proveedor

![](images/clipboard-2642875005.png)

#### 17. Caso de uso para eliminar Proveedor

![](images/clipboard-2110151564.png)

#### 18. Caso de uso para consultar Proveedor

![](images/clipboard-127697644.png)

#### 19. Caso de uso para listar Proveedores

![](images/clipboard-1697966176.png)

**20. Caso de uso para actualizar Proveedor**

![](images/clipboard-2293486065.png)

**21. Serializer HTTP de Proveedor**

![](images/clipboard-2234605100.png)

**22. Controlador HTTP de Proveedores**

![](images/clipboard-749519424.png)

#### 23. Índice del módulo de Proveedores

![](images/clipboard-1569098843.png)

**24. Módulo de Proveedores**

![](images/clipboard-3547272725.png)

**25. Registro del modelo de Proveedor en Sequelize**

![](images/clipboard-3242090012.png)

**26. Registro del módulo de Proveedores en BusinessModule**

![](images/clipboard-1089942763.png)

**27. Registro del Seeder de Proveedores**

![](images/clipboard-1076323790.png)

**28. Registro del módulo de Proveedores en AppModule**

![](images/clipboard-69141314.png)

#### **Verificar tabla física Proveedor y API**

![](images/clipboard-387683650.png)

### Entidad Inventario — HuellaMarket

![](images/clipboard-4166686239.png)

#### 2. Excepción de Inventario no encontrado

![](images/clipboard-1439863013.png)

#### 3. DTO para crear Inventario

![](images/clipboard-337441693.png)

#### 4. DTO para actualizar Inventario

![](images/clipboard-4223288735.png)

#### 5. DTO para listar Inventario

![](images/clipboard-2293687710.png)

#### 6. DTO de respuesta de Inventario

![](images/clipboard-3818383457.png)

#### 7. Mapper de Inventario

![](images/clipboard-2084456293.png)

#### 8. Modelo Sequelize de Inventario

![](images/clipboard-2942314078.png)

#### 9. Interfaz del repositorio de Inventario

![](images/clipboard-3654749772.png)

#### **Verificar tabla física Inventario y API**

![](images/clipboard-4194214237.png)

### Entidad Venta — HuellaMarket

![](images/clipboard-1448327350.png)

#### 2. Excepción de Venta no encontrada

![](images/clipboard-2822432560.png)

#### 3. DTO para crear Venta

![](images/clipboard-812868642.png)

#### 4. DTO para actualizar Venta

![](images/clipboard-3962752097.png)

#### 5. DTO para listar Ventas

![](images/clipboard-3644664111.png)

#### 6. DTO de respuesta de Venta

![](images/clipboard-2237765996.png)

#### 7. Mapper de Venta

![](images/clipboard-2693476899.png)

#### 8. Modelo Sequelize de Venta

![](images/clipboard-3597977589.png)

#### 9. Interfaz del repositorio de Venta

![](images/clipboard-354911254.png)

#### **Verificar tabla física Venta y API**

![](images/clipboard-2131894063.png)

### Entidad VentaDetalle — HuellaMarket

![](images/clipboard-681720676.png)

#### 2. Excepción de VentaDetalle no encontrado

![](images/clipboard-117912599.png)

#### 3. DTO para crear VentaDetalle

![](images/clipboard-3991090651.png)

#### 4. DTO para actualizar VentaDetalle

![](images/clipboard-188092640.png)

#### 5. DTO de respuesta de VentaDetalle

![](images/clipboard-3320073318.png)

#### 6. Mapper de VentaDetalle

![](images/clipboard-2848776871.png)

#### 7. Modelo Sequelize de VentaDetalle

![](images/clipboard-2709514950.png)

#### 8. Interfaz del repositorio de VentaDetalle

![](images/clipboard-1275418575.png)

#### **Verificar tabla física VentaDetalle y API**

![](images/clipboard-4089786219.png)

### Entidad Pago — HuellaMarket

![](images/clipboard-2078048989.png)

#### 2. Excepción de Pago no encontrado

![](images/clipboard-379673208.png)

#### 3. DTO para crear Pago

![](images/clipboard-478337815.png)

#### 4. DTO para actualizar Pago

![](images/clipboard-1391068527.png)

#### 5. DTO de respuesta de Pago

![](images/clipboard-955944393.png)

#### 6. Mapper de Pago

![](images/clipboard-569120134.png)

#### 7. Modelo Sequelize de Pago

![](images/clipboard-1046235390.png)

#### 8. Interfaz del repositorio de Pago

![](images/clipboard-3948008302.png)

#### **Verificar tabla física Pago y API**

![](images/clipboard-1095784956.png)
